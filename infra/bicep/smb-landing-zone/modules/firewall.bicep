        ...
        rules: [
          {
            ...
            description: 'Allow Azure Monitor for logging and metrics'
            ipProtocols: [
              'TCP'
            ]
            sourceAddresses: [
          ...
          }
          {
            ...
            description: 'Allow Azure Backup service'
            ipProtocols: [
              'TCP'
            ]
            sourceAddresses: [
          ...
          }
          {
            ...
            description: 'Allow Azure Storage for various services'
            ipProtocols: [
              'TCP'
            ]
            sourceAddresses: [
          ...
          }
          {
            ruleType: 'NetworkRule'
            name: 'AllowAzureKMS'
            description: 'Allow Windows activation via Azure KMS'
            ipProtocols: [
              'TCP'
            ]
            sourceAddresses: [
            ...
            destinationAddresses: [
              '23.102.135.246' // Azure KMS
              '20.118.99.224'  // Azure KMS alternate
            ]
            destinationPorts: [
              '1688'
            ]
