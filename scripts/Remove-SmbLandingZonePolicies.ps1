<#
.SYNOPSIS
    Removes all Azure Policy assignments deployed by the SMB Landing Zone project.

.DESCRIPTION
    This script removes all policy assignments created by the SMB Landing Zone Bicep templates.
    It identifies policies by the 'Project' tag set to 'smb-landing-zone' or by a naming convention prefix.

.PARAMETER SubscriptionId
    The Azure subscription ID where policies are deployed. If not specified, uses the current context.

.PARAMETER ProjectName
    The project name used to identify policy assignments. Defaults to 'smb-landing-zone'.
...
.EXAMPLE
    .\Remove-SmbLandingZonePolicies.ps1 -SubscriptionId "00000000-0000-0000-0000-000000000000"
...
param(
    ...
    [Parameter()]
    [string]$ProjectName = 'smb-landing-zone',
...
try {
    ...
    Write-LogMessage '  SMB Landing Zone - Policy Cleanup Script' -Level Info
    Write-LogMessage '═══════════════════════════════════════════════════════════════' -Level Info
