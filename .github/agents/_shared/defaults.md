...
> Generated by {agent-name} agent | {YYYY-MM-DD} | Artifact v{artifact-version}
> **Confidence Level**: {High|Medium|Low}
```

### Artifact Versioning

- **Project Version**: Tracked in `package.json` (semantic versioning)
- **Artifact Version**: Tracked in each file header (e.g., `v0.1`, `v0.2`)
- **Version Increment**: Bump artifact version when content is significantly revised
- **Current Project Version**: Check `package.json` for latest
