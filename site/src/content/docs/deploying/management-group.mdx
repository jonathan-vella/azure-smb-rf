...
SMB Ready Foundations deploys governance at the management group scope — ensuring policies apply to all resources in the subscription, even those created outside of this deployment.
