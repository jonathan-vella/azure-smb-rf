...
description: Deploy SMB Ready Foundations from zero to running infrastructure
sidebar:
  order: 2
---
...
This walkthrough takes you from an empty subscription to a fully deployed SMB Ready Foundations environment. Choose the **Bicep** or **Terraform** tab for your preferred IaC track.
...
<ThemedImage
  src="/images/architecture-baseline.png"
  alt="Baseline architecture — hub-spoke with NAT Gateway"
  caption="Baseline scenario — hub-spoke topology with NAT Gateway"
/>
