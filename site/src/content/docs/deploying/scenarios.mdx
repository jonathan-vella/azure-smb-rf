...
SMB Ready Foundations offers four deployment scenarios, each adding network security and hybrid connectivity capabilities at increasing cost.
...
**Deployment time**: ~25 minutes (VPN Gateway creation takes 25–45 minutes).
...
**Deployment time**: ~45 minutes (Firewall + VPN Gateway deploy sequentially).
...
<Aside type="tip">
  Costs are estimated monthly prices for Sweden Central (swedencentral) region
  as of 2026. Actual costs may vary. Use the [Azure Pricing
  Calculator](https://azure.microsoft.com/pricing/calculator/) for current
  pricing.
</Aside>
