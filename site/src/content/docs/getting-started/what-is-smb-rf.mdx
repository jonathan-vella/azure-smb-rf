---
title: What Is SMB Ready Foundation?
description: A repeatable, cost-optimized Azure landing zone for SMB VMware-to-Azure migrations
sidebar:
  order: 1
---
...
<CardGrid>
  <LinkCard title="Prerequisites" href="/azure-smb-rf/getting-started/prerequisites/" description="Tools and access needed before deploying" />
  <LinkCard title="Quick Start" href="/azure-smb-rf/getting-started/quick-start/" description="Deploy your first environment in minutes" />
  <LinkCard title="Partner Onboarding" href="/azure-smb-rf/getting-started/partner-onboarding/" description="Scale across your customer base" />
</CardGrid>
