...
description: Scale SMB Ready Foundations across your customer base
sidebar:
  order: 4
---
...
This guide helps Microsoft partners operationalize SMB Ready Foundations for multi-customer deployments.
