...
<Aside type="tip">
  This guide deploys the **baseline** scenario (~$48/month). See [Deployment
  Scenarios](/azure-smb-rf/deploying/scenarios/) for all options.
</Aside>
...
2. **Create a management group** (one-time setup)
   ...
   <Aside type="note">
     If you need management group permissions, run
     `scripts/Setup-ManagementGroupPermissions.ps1` first. See
     [Prerequisites](/azure-smb-rf/getting-started/prerequisites/).
   </Aside>
