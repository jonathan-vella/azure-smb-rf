...
A repeatable Azure infrastructure foundation designed for Microsoft Partners migrating SMB customers from VMware to Azure. It provides hub-spoke networking, 34 governance policies, and 4 deployment scenarios — all deployable with a single `azd up` command.
