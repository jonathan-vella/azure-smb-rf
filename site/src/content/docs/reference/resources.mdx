...
![Management group hierarchy showing smb-rf under tenant root](/azure-smb-rf/images/mg-hierarchy.png "Management group hierarchy: Tenant Root → smb-rf → target subscription")
