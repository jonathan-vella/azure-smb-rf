...
<ThemedImage
  ...
  caption="Baseline scenario — hub-spoke with NAT Gateway"
/>
...
<ThemedImage
  src="/images/architecture-firewall.png"
  alt="Firewall architecture — centralized egress via Azure Firewall"
  caption="Firewall scenario — centralized egress via Azure Firewall"
/>
...
<ThemedImage
  src="/images/architecture-vpn.png"
  alt="VPN architecture — site-to-site connectivity via VPN Gateway"
  caption="VPN scenario — site-to-site connectivity via VPN Gateway"
/>
...
<ThemedImage
  ...
  alt="Full architecture — Firewall + VPN Gateway combined"
  caption="Full scenario — Firewall + VPN Gateway combined"
/>
