"""
Azure Architecture Diagram: SMB Ready Foundations - Full Scenario
...
with Diagram(
    "SMB Ready Foundations - Full Scenario (~$476/mo)",
    show=False,
    direction="TB",
    ...
    with Cluster("Management Group: smb-rf (SMB Ready Foundations)"):
