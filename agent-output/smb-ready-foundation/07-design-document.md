# Azure Design Document: SMB Ready Foundations
...
This design document provides comprehensive technical documentation for the SMB Ready Foundations
...
The SMB Ready Foundations is a repeatable Azure infrastructure pattern designed for Microsoft Partners
hosting 1000+ small business customers migrating from on-premises VMware environments. It provides
a cost-optimized, policy-enforced, standards-aligned foundation for workload migrations.
...
- Single subscription per customer (not multi-subscription SMB Ready Foundations)
...
The SMB Ready Foundations uses a **hub-and-spoke** topology within a single subscription:

| VNet                | Purpose              | Address Space | Peered To |
| ------------------- | -------------------- | ------------- | --------- |
| vnet-hub-smb-swc    | Centralized services | 10.0.0.0/23   | Spoke     |
...
> **Note**: This SMB Ready Foundations prioritizes cost over high availability. No zone redundancy
...
_Design document generated by docs agent for SMB Ready Foundations v0.3.0._
