# Azure Design Document: SMB Ready Foundation
...
This design document provides comprehensive technical documentation for the SMB Ready Foundation
...
The SMB Ready Foundation is a repeatable Azure infrastructure pattern designed for Microsoft Partners
...
- Single subscription per customer (not multi-subscription SMB Ready Foundation)
...
The SMB Ready Foundation uses a **hub-and-spoke** topology within a single subscription:
...
> **Note**: This SMB Ready Foundation prioritizes cost over high availability. No zone redundancy
...
_Design document generated by docs agent for SMB Ready Foundation v0.3.0._
