# Backup and Disaster Recovery Plan: SMB Ready Foundations
...
This document defines the backup strategy and disaster recovery procedures for the SMB Ready Foundations.
...
| ------------------- | ------------------------------------- |
| Backup Vault        | rsv-smbrf-smb-swc                     |
...
# Restore to new VM
$restorejob = Restore-AzRecoveryServicesBackupItem -RecoveryPoint $rp[0] -TargetResourceGroupName "rg-spoke-prod-swc" -StorageAccountName "strecoveryswc" -StorageAccountResourceGroupName "rg-backup-smb-swc"
```
...
> ⚠️ This SMB Ready Foundations does not include automated region failover. Recovery requires manual
...
_Backup and DR plan generated by docs agent for SMB Ready Foundations v0.3.0._
