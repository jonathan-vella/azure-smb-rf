...
- **POS-007**: Standardized naming and tagging enforced automatically via Azure Policy
...
- **IMP-005**: Use policy cleanup script (`scripts/Remove-SmbReadyFoundationPolicies.ps1`) when
...
- **REF-002**: [Azure Single Subscription Design](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/landing-zone/design-area/resource-org-subscriptions)
