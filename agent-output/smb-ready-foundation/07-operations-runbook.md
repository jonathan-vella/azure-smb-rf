# Operations Runbook: SMB Ready Foundations
...
Reset-AzVirtualNetworkGateway -VirtualNetworkGateway (Get-AzVirtualNetworkGateway -Name "vpng-hub-smb-swc" -ResourceGroupName "rg-hub-smb-swc")
```
...
```powershell
# Check current usage
$ws = Get-AzOperationalInsightsWorkspace -Name "log-smbrf-smb-swc" -ResourceGroupName "rg-monitor-smb-swc"
$usage = Get-AzOperationalInsightsUsage -Workspace $ws
$usage | Format-Table

# Increase daily cap (requires cost approval)
Set-AzOperationalInsightsWorkspace -Name "log-smbrf-smb-swc" -ResourceGroupName "rg-monitor-smb-swc" -DailyQuotaGb 1.0
```
...
Get-AzConsumptionBudget -Name "budget-smb-monthly"

# Update budget amount
Set-AzConsumptionBudget -Name "budget-smb-monthly" -Amount 600
```
...
$vault = Get-AzRecoveryServicesVault -Name "rsv-smbrf-smb-swc" -ResourceGroupName "rg-backup-smb-swc"
...
_Operations runbook generated by docs agent for SMB Ready Foundations v0.4.0._
