# Compliance Matrix: SMB Landing Zone
...
This compliance matrix maps the SMB Landing Zone security controls to Azure Security Baseline
...
**Evidence Location**: `infra/bicep/smb-landing-zone/modules/networking-*.bicep`
...
**Evidence Location**: `infra/bicep/smb-landing-zone/modules/policy-storage.bicep`
...
**Evidence Location**: `infra/bicep/smb-landing-zone/modules/policy-identity.bicep`
...
**Evidence Location**: `infra/bicep/smb-landing-zone/modules/monitoring.bicep`
...
**Evidence Location**: `agent-output/smb-landing-zone/07-operations-runbook.md`
...
| AM-2       | Tag compliance         | Azure Policy → smb-lz-compliance-01       | 2026-02-02     |
...
| -------------------- | ----------------- | --------------- |
| smb-lz-compute-01    | Deny              | 100%            |
| smb-lz-compute-02    | Deny              | 100%            |
| smb-lz-network-01    | Audit             | 100%            |
| smb-lz-storage-01    | Deny              | 100%            |
| smb-lz-identity-01   | Deny              | 100%            |
| smb-lz-compliance-01 | Audit             | 100%            |
| smb-lz-backup-02     | DeployIfNotExists | 100%            |
...
_Compliance matrix generated by docs agent for SMB Landing Zone v0.3.0._
