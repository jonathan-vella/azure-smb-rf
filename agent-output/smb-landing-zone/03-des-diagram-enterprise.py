"""
Azure Architecture Diagram: SMB Landing Zone - Enterprise Scenario
Generated by Diagram agent
Date: 2026-01-29

Scenario: Enterprise (Azure Firewall + VPN Gateway)
Monthly Cost: ~$476
...
Generate PNG: python 03-des-diagram-enterprise.py
"""
...
with Diagram(
    "SMB Landing Zone - Enterprise Scenario (~$476/mo)",
    show=False,
    direction="TB",
    filename="03-des-diagram-enterprise",
